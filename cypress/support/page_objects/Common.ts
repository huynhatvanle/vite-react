...
export default class Common {
  elements = {
    ...
    forItemByName: (name: string) => cy.contains('.ant-form-item-label > label', name).parent().parent().should('be.visible'),
    inputByName: (name: string) => this.elements.forItemByName(name).find('input').should('be.visible'),
    errorByName: (name: string) => this.elements.forItemByName(name).find('.ant-form-item-explain-error').should('be.visible'),
