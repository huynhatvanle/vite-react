...
VLOT-02 Verify that Staff can search successfully when entering correct keyword to search box with "Tên nhóm"
    Login to Staff
    When Click "Thiết lập" menu
    And Click "Nhóm" sub menu to "vn/team"
...
VLOT-03 Verify that Staff can search unsuccessfully when entering incorrect keyword to search box
    Login to Staff
    When Click "Thiết lập" menu
    And Click "Nhóm" sub menu to "vn/team"
