      ...
      <div className="col-span-12 md:col-span-4 lg:col-span-3 -intro-x">
        <div className="shadow rounded-xl w-full bg-white overflow-hidden">
          <div className="h-14 flex justify-between items-center border-b border-gray-100 px-4 py-2">
            <h3 className={'font-bold text-xl'}>Type Code</h3>
            ...
            <div className="h-[calc(100vh-13rem)] overflow-y-auto relative scroll">
              {result?.data?.map((data, index) => (
                <button
                  key={data.id}
                  className={
                    'item text-gray-700 font-medium hover:bg-gray-100 flex justify-between items-center border-b border-gray-100 w-full text-left px-4 h-10 group'
                  }
                >
                  <span className="truncate cursor-pointer flex-1 hover:text-blue-500 item-text">
                    {index + 1}. {data.name}
                  </span>
