  ...
  return (
    <Fragment>
      <div className={'relative group'}>
        ...
        >
          {[1,2,3,4].map((i) => <SwiperSlide key={i} className={'flex items-center h-96'}>
      ...
      <div className={'relative group bg-gray-100'}>
        <div className="absolute z-10 w-full h-0 top-[calc(50%-1.125rem)]">
          <div className={'flex  justify-between container mx-auto'}>
            <Arrow
              className="w-9 h-9 rotate-180 transition-all duration-500 ease-in-out relative -left-20 group-hover:-left-12 opacity-0 group-hover:opacity-100 bg-gray-300 hover:bg-blue-600 hover:text-white p-2 rounded-full cursor-pointer"
              onClick={() => swiperRef1?.slidePrev()}
            />
            <Arrow
              className="w-9 h-9 transition-all duration-500 ease-in-out relative -right-20 group-hover:-right-12 opacity-0 group-hover:opacity-100 bg-gray-300 hover:bg-blue-600 hover:text-white p-2 rounded-full cursor-pointer"
        ...
        >
          {[1,2,3,4,5,6,7,8,9].map((i) => <SwiperSlide key={i} className={'flex items-center h-96'}>
            <div className={'container mx-auto'}>
              <h1 className="split-text text-xl xl:text-2xl text-blue-500 font-bold leading-none mt-8">
                Enhance Vietnam’s intellectual value
              </h1>
              <p className="text-gray-500 leading-none top">{i} Choose the service you want us to help with </p>
              <div className="right mt-10 mb-3 ng-star-inserted">
