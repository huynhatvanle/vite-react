      ...
      <div className={'relative group '}>
        <div className="absolute z-10 w-full h-0 top-[calc(50%-1.125rem)]">
          <div className={'flex  justify-between container mx-auto'}>
            <Arrow className="w-9 h-9 rotate-180 transition-all duration-500 ease-in-out relative -left-10 group-hover:left-0 opacity-0 group-hover:opacity-100 bg-gray-300 hover:bg-blue-600 hover:text-white p-2 rounded-full cursor-pointer" onClick={() => swiperRef?.slidePrev()} />
            <Arrow className="w-9 h-9 transition-all duration-500 ease-in-out relative -right-10 group-hover:right-0 opacity-0 group-hover:opacity-100 bg-gray-300 hover:bg-blue-600 hover:text-white p-2 rounded-full cursor-pointer" onClick={() => swiperRef?.slideNext()} />
          </div>
        </div>
        <Swiper
          effect="fade"
        ...
        >
          <SwiperSlide className={'flex items-center h-96'}>
            <div className={'container mx-auto px-12'}>
              ...
              <a onClick={() => console.log('1')} className="bottom bg-blue-500 text-white px-5 py-3 inline-block rounded-3xl">
          ...
          <SwiperSlide className={'flex items-center h-96'}>
            <div className={'container mx-auto px-12'}>
              ...
              <a onClick={() => console.log('2')} className="bottom bg-blue-500 text-white px-5 py-3 inline-block rounded-3xl">
                Get Started <i className="las la-arrow-right ml-1"></i>
              </a>
            </div>
          ...
          <SwiperSlide className={'flex items-center h-96'}>
            <div className={'container mx-auto px-12'}>
              ...
              <a onClick={() => console.log('3')} className="bottom bg-blue-500 text-white px-5 py-3 inline-block rounded-3xl">
                Get Started <i className="las la-arrow-right ml-1"></i>
              </a>
            </div>
          ...
          <SwiperSlide className={'flex items-center px-12 h-96'}>
            <div className={'container mx-auto px-12'}>
              ...
              <a onClick={() => console.log('4')} className="bottom bg-blue-500 text-white px-5 py-3 inline-block rounded-3xl">
                Get Started <i className="las la-arrow-right ml-1"></i>
              </a>
            </div>
