...
import {
  ColumnFormSupplier,
  ColumnFormSupplierDetail,
  ColumnTableSupplierDiscount,
  ColumnTableSupplierOrder,
  ColumnTableSupplierProduct,
} from './column';
...
const Page = () => {
  ...
  return (
    <div className={'w-full'}>
      <Fragment>
        <div className="">
          <Tabs defaultActiveKey="1" type="card" size="large" className="relative">
